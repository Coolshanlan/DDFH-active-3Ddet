...
def parse_config():
    ...
    parser.add_argument('--cuda_device_number', type=str, default="0", help='')
...
def main():
    ...
    args.ckpt_save_interval = cfg.ACTIVE_TRAIN.SELECT_LABEL_EPOCH_INTERVAL
    ...
    if cfg.LOCAL_RANK == 0:
        ...
        # wandb.init(project=cfg.DATA_CONFIG._BASE_CONFIG_.split('/')[-1].split('.')[0] + '_train', entity="coolshan", tags=args.cfg_file.split('/')[-1].split('.')[0])
